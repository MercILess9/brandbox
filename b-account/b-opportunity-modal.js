...
<style>
    ...
    .bopp-left2-div { width: 1px; background: #eef2f7; flex-shrink: 0; }
    .bopp-left2-remark { flex: 1; display: flex; flex-direction: column; min-width: 0; }
    .bopp-date-row { display: flex; gap: 10px; }
    .bopp-date-row > div { flex: 1; min-width: 0; }
    .bopp-right-panel { display: flex; flex-direction: column; gap: 10px; }
    ...
    .bopp-qt-head { background: #f8fafc; border-bottom: 1px solid #e2e8f0; padding: 9px 14px; display: flex; align-items: center; gap: 10px; flex-wrap: wrap; }
    ...
    .bopp-item-tbl th { padding: 7px 10px; text-align: left; font-size: 0.58rem; font-weight: 800; text-transform: uppercase; letter-spacing: 0.5px; color: #94a3b8; background: #f8fafc; border-bottom: 1px solid #f1f5f9; white-space: nowrap; }
    .bopp-item-tbl th.r, .bopp-item-tbl td.r { text-align: right; }
    .bopp-item-tbl th.c, .bopp-item-tbl td.c { text-align: center; }
    .bopp-item-tbl td { padding: 5px 8px; border-bottom: 1px solid #f8fafc; vertical-align: middle; }
                ...
                <div class="bopp-body">
                    ...
                    <div class="bopp-outer">
                        ...
                        <div class="bopp-left">
                            ...
                            <!-- Left 1: ACC 50 | Company 50 / OPP Name full -->
                            <div class="bopp-card">
                            ...
                            <!-- Left 2: [Dates+Links | Remark] -->
                            <div class="bopp-card bopp-left2">
                                <div class="bopp-left2-links">
                                ...
                                <div class="bopp-left2-div"></div>
                                <div class="bopp-left2-remark">
                                    <label class="bq-lbl">Remark</label>
                                    <textarea id="bopp-remark" class="bq-inp bq-ta" style="flex:1; min-height:120px;" placeholder="Note..."></textarea>
                                </div>
                            </div>

                        </div><!-- /bopp-left -->

                        <!-- RIGHT 20%: 5 Dropdowns centered -->
